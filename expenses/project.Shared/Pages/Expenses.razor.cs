...
namespace project.Shared.Pages
{
    public partial class Expenses : ComponentBase
    {
        ...
        {
            // Validation
            if (string.IsNullOrWhiteSpace(NewExpense.Staff))
            {
            ...
            // Added Invoice Title Validation
            if (string.IsNullOrWhiteSpace(NewExpense.InvoiceTitle))
            {
                ErrorMessage = "Please enter an invoice title.";
                IsErrorPopupOpen = true;
                return;
            }
